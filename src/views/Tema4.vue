...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    h5.mb-4 Entrevistas
    p.mb-4 La entrevista es la técnica más utilizada y versátil en el levantamiento de requisitos. Consiste en una conversación estructurada o semi-estructurada entre el analista y uno o más stakeholders, orientada a comprender procesos, necesidades, problemas y expectativas relacionadas con el sistema.
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-10
        .p-4.bgf2
          .row.justify-content-center.align-items-center.mb-4
            .col-lg-9
              p Las entrevistas semi-estructuradas son especialmente recomendadas en proyectos de #[i software], ya que permiten cubrir los temas planificados mientras se exploran aspectos relevantes no anticipados. Pueden realizarse de manera presencial o virtual mediante herramientas como Zoom o Microsoft Teams.
              p.mb-0 Para una entrevista efectiva se recomienda preparar una guía de preguntas con anticipación, iniciar con preguntas abiertas, aplicar técnicas de escucha activa, grabar la sesión con consentimiento explícito y elaborar un acta de entrevista dentro de las 24 horas siguientes para validarla con el entrevistado.        
            .col-lg-3
              figure
                img(src='@/assets/curso/temas/tema4/img4.png', alt='Infografía de matriz RACI')
    h5.mb-4 Observación directa
    ...
    .tarjeta--container.row.mb-5
      .col-md.tarjeta.color-primario.p-5
        ...
        h2.text-center Observación estructurada
      ...
      .col-md.tarjeta.bgf6.p-5
        ...
        h2.text-center Análisis de tareas
      ...
      .col-md.tarjeta.bgf1.p-5
        ...
        h2.text-center Estudios contextuales
        ...
        .d-none.d-lg-block.mb-4
          ImagenInfografica.color-acento-botones
            template(v-slot:imagen)
              figure
                img(src='@/assets/curso/temas/tema4/img8.svg', alt='Infografía de matriz RACI')
        .d-block.d-lg-none
          figure
            img(src='@/assets/curso/temas/tema4/img8_1.svg', alt='Matriz RACI para dispositivos móviles')
    h5.mb-4 Encuestas
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-9
        ...
        .p-4.bgf2
          p El uso de herramientas digitales facilita la distribución, el análisis automático de respuestas y la generación de reportes estadísticos. En muchos casos, las encuestas anónimas permiten obtener respuestas más honestas, especialmente cuando se indaga sobre deficiencias del sistema actual.
      .col-lg-3
        figure
    ...
    #t_4_2.titulo-segundo.color-acento-contenido(data-aos="fade-left")
      h2 4.2 Focus group como técnica de recopilación de información
    ...
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-10
        p La siguiente tabla compara el focus group con la entrevista individual, las dos técnicas cualitativas más utilizadas en el levantamiento de requisitos. Esta comparación ayuda al analista a decidir cuál técnica es más apropiada según los objetivos específicos de cada fase del proceso de elicitación:
        .row.justify-content-center.align-items-center.mb-3
          .col-lg-12
            .titulo-sexto.color-acento-contenido
              h5 Tabla 6.
              span Focus group vs. entrevistas: criterios para la selección de la técnica
        .row.justify-content-center.align-items-center.mb-4
          .col-lg-12
    ...
    h5.mb-4 Roles en un taller JAD
            ...
            .col-lg-10
              ...
              .d-none.d-lg-block.mb-4
                ImagenInfografica.color-acento-botones
                  template(v-slot:imagen)
                    figure
                      img(src='@/assets/curso/temas/tema4/img19.svg', alt='Infografía de matriz RACI')
            ...
            .col-lg-10
              ...
              .d-none.d-lg-block.mb-4
                ImagenInfografica.color-acento-botones
                  template(v-slot:imagen)
                    figure
                      img(src='@/assets/curso/temas/tema4/img20.svg', alt='Infografía de matriz RACI')
            ...
            .col-lg-10
              ...
              .d-none.d-lg-block.mb-4
                ImagenInfografica.color-acento-botones
                  template(v-slot:imagen)
                    figure
                      img(src='@/assets/curso/temas/tema4/img21.svg', alt='Infografía de matriz RACI')
            ...
            .col-lg-10
              ...
              .d-none.d-lg-block.mb-4
                ImagenInfografica.color-acento-botones
                  template(v-slot:imagen)
                    figure
                      img(src='@/assets/curso/temas/tema4/img22.svg', alt='Infografía de matriz RACI')
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-10
        .p-4.bgf2-1.text-center.mb-4  
    ...
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-10
        .p-4.text-center.mb-4  
          p.mb-0 Los talleres JAD, igualmente poseen unos aspectos positivos y negativos como son:
      .col-md.tarjeta.color-primario.p-5
        .row.justify-content-center.mb-4
          .col-6
            figure
        ...
        p ° Mayor compromiso de los stakeholders con las decisiones tomadas.
        p ° Creatividad potenciada por la interacción grupal.
      .col-md.tarjeta.bgf1.p-5
        .row.justify-content-center.mb-4
          .col-6
            figure
        ...
        p ° Fatiga de participantes en sesiones muy extensas.
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-10
        .p-4.text-center 
